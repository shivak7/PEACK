...
def stats_all_poses_combined(group_pair, selected_stat):
    
    stat_compare_combined(df,'Muscles', group_pair, selected_stat)
    stat_compare_combined(df,'PowerBars', group_pair, selected_stat)
...
ext = 'svg'
selected_stat = mannwhitneyu#kruskal
